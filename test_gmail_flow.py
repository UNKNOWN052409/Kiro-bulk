"""Test with Gmail to check if ERR-837 is domain-specific."""
...
def main():
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            print(f"After email: onName={state['onName']}, onOtp={state['onOtp']}, err={state['onErr']}, rateLimit={state['onRateLimit']}")
            ...
            if state['onName']:
                ...
                if inp:
                    ...
                    if state['onOtp']:
                        print("[+] NAME PAGE PASSED WITH GMAIL! Flow works!")
                    
                    if state['onErr']:
                        print("[!] ERR-837 even with Gmail - it's IP-based!")
