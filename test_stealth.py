...
reg_payload = {
    ...
    "redirectUris": ["http://127.0.0.1:9994/oauth/callback"],
...
redirect_uri = 'http://127.0.0.1:9994/oauth/callback'
...
name = "Vikram Singh"
password = "TestPass9012!"

print(f"Email: {email}")
print("Testing with playwright-stealth...")
