...
reg_payload = {
    ...
    "redirectUris": ["http://127.0.0.1:9993/oauth/callback"],
...
redirect_uri = 'http://127.0.0.1:9993/oauth/callback'
...
name = "Amit Kumar"
password = "TestPass3456!"

print(f"Email: {email}")
print("Testing with CDP connection to pre-launched Chrome...")

with sync_playwright() as p:
    # Connect to the pre-launched Chrome via CDP
